...
public class ForgetpanyPwdActivity extends BaseActivity {
    ...
    @BindView(R.id.pany_phone)
    EditText mPanyPhone;//手机号
    @BindView(R.id.pany_psw)
    EditText mPanyPsw;//密码
    @BindView(R.id.pany_again_psw)
    EditText mPanyAgainPsw;//确认密码
    ...
    @OnClick({R.id.naviFrameLeft, R.id.tv_get_verification, R.id.again_psw})
    ...
    public void getNetVerification() {
        ...
        String photoNum = MyPublic.getText(mPanyPhone);
        ...
        MyPublic.getVerification(ForgetpanyPwdActivity.this, photoNum, mTvGetVerification, "1");
    }
    ...
    public void getNetUpdatePwd() {
        ...
        String UserPhoto = MyPublic.getText(mPanyPhone);
        ...
        String psw = MyPublic.getText(mPanyPsw);
        if (TextUtils.isEmpty(psw)) {
            showToast("请输入密码");
            return;
        }
        String againPsw = MyPublic.getText(mPanyAgainPsw);
        ...
        APPApi.getInstance().service
                .panyPsw(UserPhoto, psw, doSendCode)
                ...
                .subscribe(new Observer<BaseBean>() {
                    ...
                    public void onError(Throwable e) {
                        pDialog.cancel();
                        LogUtil.e("Fc_修改支付密码，请求网路失败" + e.getMessage());
