...
public class UserMyCollectionMaterialFragment extends BaseFragment {
    ...
    protected void initData(Bundle arguments) {
        mAdapter = new UserMyCollectionGoodsAdapter();
...
//                .myCollectionMaterial("1", "3")
                ...
                .subscribe(new Observer<UserCollectionMaterialBean>() {
                    ...
                    @Override
                    public void onNext(UserCollectionMaterialBean bean) {
                    ...
                    public void onError(Throwable e) {
                        ...
                        LogUtil.e("Fc_我的收藏-sahngpin" + e.getMessage());
