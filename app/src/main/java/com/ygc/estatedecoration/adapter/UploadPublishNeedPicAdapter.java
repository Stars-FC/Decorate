...
import com.ygc.estatedecoration.user_activity.UserPublishActivity;

import java.util.List;

import me.iwf.photopicker.PhotoPicker;

public class UploadPublishNeedPicAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    private List<String> data;
    private UserPublishActivity context;
    public UploadPublishNeedPicAdapter(@LayoutRes int layoutResId, @Nullable List<String> data, UserPublishActivity context) {
